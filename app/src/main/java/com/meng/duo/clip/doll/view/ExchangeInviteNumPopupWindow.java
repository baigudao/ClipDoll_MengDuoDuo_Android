...
/**
 * Created by Devin on 2017/12/5 16:22
 * E-mail:971060378@qq.com
 */

public class ExchangeInviteNumPopupWindow extends PopupWindow implements View.OnClickListener {

    private ExchangeInviteNumListener listener;
    protected Context context;

    public interface ExchangeInviteNumListener {
    ...
    public ExchangeInviteNumPopupWindow(Context context, ExchangeInviteNumListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.exchange_invite_num_popup_window, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ExchangeInviteNumPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
