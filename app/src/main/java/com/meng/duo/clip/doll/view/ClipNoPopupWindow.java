...
/**
 * Created by Devin on 2017/12/5 17:23
 * E-mail:971060378@qq.com
 */

public class ClipNoPopupWindow extends PopupWindow implements View.OnClickListener {

    private ClipNoListener listener;
    protected Context context;

    public interface ClipNoListener {
    ...
    public ClipNoPopupWindow(Context context, ClipNoListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.clip_no_popup_window, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ClipNoPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
